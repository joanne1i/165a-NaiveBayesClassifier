...
C/C++: ./NaiveBayesClassifier training.txt testing.txt | java -jar validate
Java: java NaiveBayesClassifier training.txt testing.txt | java -jar validate
Python: python NaiveBayesClassifier.py train.txt test.txt | java -jar validate.jar
